package ch05.instructions.factory;

import ch05.instructions.base.instruction.Instruction;
import ch05.instructions.comparisons.dcmp.DCMPG;
import ch05.instructions.comparisons.dcmp.DCMPL;
import ch05.instructions.comparisons.fcmp.FCMPG;
import ch05.instructions.comparisons.fcmp.FCMPL;
import ch05.instructions.comparisons.if_acmp.IF_ACMPEQ;
import ch05.instructions.comparisons.if_acmp.IF_ACMPNE;
import ch05.instructions.comparisons.lcmp.LCMP;
import ch05.instructions.constants.const_.*;
import ch05.instructions.constants.ipush.BIPUSH;
import ch05.instructions.constants.ipush.SIPUSH;
import ch05.instructions.constants.nop.NOP;
import ch05.instructions.control.goto_.GOTO;
import ch05.instructions.control.lookupswitch.LOOKUP_SWITCH;
import ch05.instructions.control.table_switch.TABLE_SWITCH;
import ch05.instructions.conversions.d2x.D2F;
import ch05.instructions.conversions.d2x.D2I;
import ch05.instructions.conversions.d2x.D2L;
import ch05.instructions.conversions.f2x.F2D;
import ch05.instructions.conversions.f2x.F2I;
import ch05.instructions.conversions.f2x.F2L;
import ch05.instructions.conversions.i2x.*;
import ch05.instructions.conversions.l2x.L2D;
import ch05.instructions.conversions.l2x.L2F;
import ch05.instructions.conversions.l2x.L2I;
import ch05.instructions.extended.goto_w.GOTO_W;
import ch05.instructions.extended.ifnull.IFNONNULL;
import ch05.instructions.extended.ifnull.IFNULL;
import ch05.instructions.extended.wide.WIDE;
import ch05.instructions.loads.aload.*;
import ch05.instructions.loads.dload.*;
import ch05.instructions.loads.fload.*;
import ch05.instructions.loads.iload.*;
import ch05.instructions.loads.lload.*;
import ch05.instructions.math.add.DADD;
import ch05.instructions.math.add.FADD;
import ch05.instructions.math.add.IADD;
import ch05.instructions.math.add.LADD;
import ch05.instructions.math.and.IAND;
import ch05.instructions.math.and.LAND;
import ch05.instructions.math.div.DDIV;
import ch05.instructions.math.div.FDIV;
import ch05.instructions.math.div.IDIV;
import ch05.instructions.math.div.LDIV;
import ch05.instructions.math.iinc.IINC;
import ch05.instructions.math.mul.DMUL;
import ch05.instructions.math.mul.FMUL;
import ch05.instructions.math.mul.IMUL;
import ch05.instructions.math.mul.LMUL;
import ch05.instructions.math.neg.DNEG;
import ch05.instructions.math.neg.FNEG;
import ch05.instructions.math.neg.INEG;
import ch05.instructions.math.neg.LNEG;
import ch05.instructions.math.or.IOR;
import ch05.instructions.math.or.LOR;
import ch05.instructions.math.rem.DREM;
import ch05.instructions.math.rem.FREM;
import ch05.instructions.math.rem.IREM;
import ch05.instructions.math.rem.LREM;
import ch05.instructions.math.sh.*;
import ch05.instructions.math.sub.DSUB;
import ch05.instructions.math.sub.FSUB;
import ch05.instructions.math.sub.ISUB;
import ch05.instructions.math.sub.LSUB;
import ch05.instructions.math.xor.IXOR;
import ch05.instructions.math.xor.LXOR;
import ch05.instructions.stack.dup.*;
import ch05.instructions.stack.pop.POP;
import ch05.instructions.stack.pop.POP2;
import ch05.instructions.stack.swap.SWAP;
import ch05.instructions.stores.astore.*;
import ch05.instructions.stores.dstore.*;
import ch05.instructions.stores.fstore.*;
import ch05.instructions.stores.istore.*;
import ch05.instructions.stores.lscore.*;
import ch05.instructions.comparisons.if_icmp.*;
import ch05.instructions.comparisons.ifcond.*;
