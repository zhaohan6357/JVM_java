package ch06.instructions.factory;

import ch06.instructions.base.instruction.Instruction;
import ch06.instructions.comparisons.dcmp.DCMPG;
import ch06.instructions.comparisons.dcmp.DCMPL;
import ch06.instructions.comparisons.fcmp.FCMPG;
import ch06.instructions.comparisons.fcmp.FCMPL;
import ch06.instructions.comparisons.if_acmp.IF_ACMPEQ;
import ch06.instructions.comparisons.if_acmp.IF_ACMPNE;
import ch06.instructions.comparisons.lcmp.LCMP;
...
import ch06.instructions.control.table_switch.TABLE_SWITCH;
import ch06.instructions.conversions.d2x.D2F;
import ch06.instructions.conversions.d2x.D2I;
import ch06.instructions.conversions.d2x.D2L;
import ch06.instructions.conversions.f2x.F2D;
import ch06.instructions.conversions.f2x.F2I;
import ch06.instructions.conversions.f2x.F2L;
import ch06.instructions.conversions.i2x.*;
import ch06.instructions.conversions.l2x.L2D;
import ch06.instructions.conversions.l2x.L2F;
import ch06.instructions.conversions.l2x.L2I;
import ch06.instructions.extended.goto_w.GOTO_W;
import ch06.instructions.extended.ifnull.IFNONNULL;
import ch06.instructions.extended.ifnull.IFNULL;
import ch06.instructions.extended.wide.WIDE;
import ch06.instructions.loads.aload.*;
import ch06.instructions.loads.dload.*;
import ch06.instructions.loads.fload.*;
import ch06.instructions.loads.iload.*;
import ch06.instructions.loads.lload.*;
import ch06.instructions.math.add.DADD;
import ch06.instructions.math.add.FADD;
import ch06.instructions.math.add.IADD;
import ch06.instructions.math.add.LADD;
import ch06.instructions.math.and.IAND;
import ch06.instructions.math.and.LAND;
import ch06.instructions.math.div.DDIV;
import ch06.instructions.math.div.FDIV;
import ch06.instructions.math.div.IDIV;
import ch06.instructions.math.div.LDIV;
import ch06.instructions.math.iinc.IINC;
import ch06.instructions.math.mul.DMUL;
import ch06.instructions.math.mul.FMUL;
import ch06.instructions.math.mul.IMUL;
import ch06.instructions.math.mul.LMUL;
import ch06.instructions.math.neg.DNEG;
import ch06.instructions.math.neg.FNEG;
import ch06.instructions.math.neg.INEG;
import ch06.instructions.math.neg.LNEG;
import ch06.instructions.math.or.IOR;
import ch06.instructions.math.or.LOR;
import ch06.instructions.math.rem.DREM;
import ch06.instructions.math.rem.FREM;
import ch06.instructions.math.rem.IREM;
import ch06.instructions.math.rem.LREM;
import ch06.instructions.math.sh.*;
import ch06.instructions.math.sub.DSUB;
import ch06.instructions.math.sub.FSUB;
import ch06.instructions.math.sub.ISUB;
...
import ch06.instructions.stack.swap.SWAP;
import ch06.instructions.stores.astore.*;
import ch06.instructions.stores.dstore.*;
import ch06.instructions.stores.fstore.*;
import ch06.instructions.stores.istore.*;
import ch06.instructions.stores.lscore.*;
import ch06.instructions.comparisons.if_icmp.*;
import ch06.instructions.comparisons.ifcond.*;
