...
/*
    ...
    public static ch06.rtda.OperandStack newOperandStack(UInteger maxStack){
        if(maxStack.intValue()>0){
            ch06.rtda.OperandStack operandStack=new ch06.rtda.OperandStack();
