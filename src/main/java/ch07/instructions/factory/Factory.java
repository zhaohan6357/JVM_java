package ch07.instructions.factory;

import ch07.instructions.base.instruction.Instruction;
import ch07.instructions.comparisons.dcmp.DCMPG;
import ch07.instructions.comparisons.dcmp.DCMPL;
import ch07.instructions.comparisons.fcmp.FCMPG;
import ch07.instructions.comparisons.fcmp.FCMPL;
import ch07.instructions.comparisons.if_acmp.IF_ACMPEQ;
import ch07.instructions.comparisons.if_acmp.IF_ACMPNE;
import ch07.instructions.comparisons.lcmp.LCMP;
import ch07.instructions.constants.const_.*;
import ch07.instructions.constants.ipush.BIPUSH;
import ch07.instructions.constants.ipush.SIPUSH;
import ch07.instructions.constants.ldc.LDC;
import ch07.instructions.constants.ldc.LDC2_W;
import ch07.instructions.constants.ldc.LDC_W;
import ch07.instructions.constants.nop.NOP;
import ch07.instructions.control.goto_.GOTO;
import ch07.instructions.control.lookupswitch.LOOKUP_SWITCH;
import ch07.instructions.control.return_.*;
import ch07.instructions.control.table_switch.TABLE_SWITCH;
import ch07.instructions.conversions.d2x.D2F;
import ch07.instructions.conversions.d2x.D2I;
import ch07.instructions.conversions.d2x.D2L;
import ch07.instructions.conversions.f2x.F2D;
import ch07.instructions.conversions.f2x.F2I;
import ch07.instructions.conversions.f2x.F2L;
import ch07.instructions.conversions.i2x.*;
import ch07.instructions.conversions.l2x.L2D;
import ch07.instructions.conversions.l2x.L2F;
import ch07.instructions.conversions.l2x.L2I;
import ch07.instructions.extended.goto_w.GOTO_W;
import ch07.instructions.extended.ifnull.IFNONNULL;
import ch07.instructions.extended.ifnull.IFNULL;
import ch07.instructions.extended.wide.WIDE;
import ch07.instructions.loads.aload.*;
import ch07.instructions.loads.dload.*;
import ch07.instructions.loads.fload.*;
import ch07.instructions.loads.iload.*;
import ch07.instructions.loads.lload.*;
import ch07.instructions.math.add.DADD;
import ch07.instructions.math.add.FADD;
import ch07.instructions.math.add.IADD;
import ch07.instructions.math.add.LADD;
import ch07.instructions.math.and.IAND;
import ch07.instructions.math.and.LAND;
import ch07.instructions.math.div.DDIV;
import ch07.instructions.math.div.FDIV;
import ch07.instructions.math.div.IDIV;
import ch07.instructions.math.div.LDIV;
import ch07.instructions.math.iinc.IINC;
import ch07.instructions.math.mul.DMUL;
import ch07.instructions.math.mul.FMUL;
import ch07.instructions.math.mul.IMUL;
import ch07.instructions.math.mul.LMUL;
import ch07.instructions.math.neg.DNEG;
import ch07.instructions.math.neg.FNEG;
import ch07.instructions.math.neg.INEG;
import ch07.instructions.math.neg.LNEG;
import ch07.instructions.math.or.IOR;
import ch07.instructions.math.or.LOR;
import ch07.instructions.math.rem.DREM;
import ch07.instructions.math.rem.FREM;
import ch07.instructions.math.rem.IREM;
import ch07.instructions.math.rem.LREM;
import ch07.instructions.math.sh.*;
import ch07.instructions.math.sub.DSUB;
import ch07.instructions.math.sub.FSUB;
import ch07.instructions.math.sub.ISUB;
import ch07.instructions.math.sub.LSUB;
import ch07.instructions.math.xor.IXOR;
import ch07.instructions.math.xor.LXOR;
import ch07.instructions.references.checkcast.CHECK_CAST;
import ch07.instructions.references.getfield.GET_FIELD;
import ch07.instructions.references.getstatic.GET_STATIC;
import ch07.instructions.references.instanceof_.INSTANCE_OF;
import ch07.instructions.references.invokeinterface.INVOKE_INTERFACE;
import ch07.instructions.references.invokespecial.INVOKE_SPECIAL;
import ch07.instructions.references.invokestatic.INVOKE_STATIC;
import ch07.instructions.references.invokevirtual.INVOKE_VIRTUAL;
import ch07.instructions.references.new_.NEW;
import ch07.instructions.references.putfield.PUT_FIELD;
import ch07.instructions.references.putstatic.PUT_STATIC;
import ch07.instructions.stack.dup.*;
import ch07.instructions.stack.pop.POP;
import ch07.instructions.stack.pop.POP2;
import ch07.instructions.stack.swap.SWAP;
import ch07.instructions.stores.astore.*;
import ch07.instructions.stores.dstore.*;
import ch07.instructions.stores.fstore.*;
import ch07.instructions.stores.istore.*;
import ch07.instructions.stores.lscore.*;
import ch07.instructions.comparisons.if_icmp.*;
import ch07.instructions.comparisons.ifcond.*;
