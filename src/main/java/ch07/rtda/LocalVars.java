...
public class LocalVars {
    public ch07.rtda.Slot[] localVars;
    ...
    public static ch07.rtda.LocalVars newLocalVars(UInteger maxLocals) {
        if(maxLocals==null){
           maxLocals=UInteger.valueOf(0);
        }
        if (maxLocals.intValue() > 0) {
            ch07.rtda.LocalVars local = new ch07.rtda.LocalVars();
            local.localVars = new ch07.rtda.Slot[maxLocals.intValue()];
