...
import ch08.classpath.ConstructEntry;
...
public class ClassPath {
   ...
   public ch08.classpath.ClassPath parse(String jreOption, String cpOption) {
        try {
            ch08.classpath.ClassPath cp = new ch08.classpath.ClassPath();
