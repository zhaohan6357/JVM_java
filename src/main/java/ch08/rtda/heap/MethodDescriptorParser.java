...
import ch08.rtda.heap.MethodDescriptor;
...
public class MethodDescriptorParser {
    String raw;
    int offset;
    ch08.rtda.heap.MethodDescriptor parsed;
    public static ch08.rtda.heap.MethodDescriptor parseMethodDescriptor(String descriptor){
        MethodDescriptorParser parser=new MethodDescriptorParser();
        return parser.parse(descriptor);
    }
    public ch08.rtda.heap.MethodDescriptor parse(String descriptor){
        this.raw=descriptor;
