...
*/
    public ch08.rtda.heap.Field ResolvedField(){
        if(field==null){
          resolveFieldRef();
        }
        return field;
    ...
    public void resolveFieldRef(){
        ch08.rtda.heap.Class d=cp.clazz;
        ch08.rtda.heap.Class c=ResolvedClass();
        ch08.rtda.heap.Field field=lookupField(c,name,descriptor);
        if(field==null){
    ...
    public ch08.rtda.heap.Field lookupField(ch08.rtda.heap.Class c, String name, String decriptor){
        for(ch08.rtda.heap.Field field:c.fields){
