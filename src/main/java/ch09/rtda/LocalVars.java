...
public class LocalVars {
    ...
    public static ch09.rtda.LocalVars newLocalVars(UInteger maxLocals) {
        if(maxLocals==null){
           maxLocals=UInteger.valueOf(0);
        }
        if (maxLocals.intValue() > 0) {
            ch09.rtda.LocalVars local = new ch09.rtda.LocalVars();
  ...
  /*  func (self LocalVars) SetRef(index uint, ref *Object) {
    ...
    public Object getThis(){
        return this.getRef(UInteger.valueOf(0));
    }
