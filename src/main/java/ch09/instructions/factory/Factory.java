package ch09.instructions.factory;

import ch09.instructions.base.instruction.Instruction;
import ch09.instructions.comparisons.dcmp.DCMPG;
import ch09.instructions.comparisons.dcmp.DCMPL;
import ch09.instructions.comparisons.fcmp.FCMPG;
import ch09.instructions.comparisons.fcmp.FCMPL;
import ch09.instructions.comparisons.if_acmp.IF_ACMPEQ;
import ch09.instructions.comparisons.if_acmp.IF_ACMPNE;
import ch09.instructions.comparisons.if_icmp.*;
import ch09.instructions.comparisons.ifcond.*;
import ch09.instructions.comparisons.lcmp.LCMP;
import ch09.instructions.constants.const_.*;
import ch09.instructions.constants.ipush.BIPUSH;
import ch09.instructions.constants.ipush.SIPUSH;
import ch09.instructions.constants.ldc.LDC;
import ch09.instructions.constants.ldc.LDC2_W;
import ch09.instructions.constants.ldc.LDC_W;
import ch09.instructions.constants.nop.NOP;
import ch09.instructions.control.goto_.GOTO;
import ch09.instructions.control.lookupswitch.LOOKUP_SWITCH;
import ch09.instructions.control.return_.*;
import ch09.instructions.control.table_switch.TABLE_SWITCH;
import ch09.instructions.conversions.d2x.D2F;
import ch09.instructions.conversions.d2x.D2I;
import ch09.instructions.conversions.d2x.D2L;
import ch09.instructions.conversions.f2x.F2D;
import ch09.instructions.conversions.f2x.F2I;
import ch09.instructions.conversions.f2x.F2L;
import ch09.instructions.conversions.i2x.*;
import ch09.instructions.conversions.l2x.L2D;
import ch09.instructions.conversions.l2x.L2F;
import ch09.instructions.conversions.l2x.L2I;
import ch09.instructions.extended.goto_w.GOTO_W;
import ch09.instructions.extended.ifnull.IFNONNULL;
import ch09.instructions.extended.ifnull.IFNULL;
import ch09.instructions.extended.wide.WIDE;
import ch09.instructions.loads.aload.*;
import ch09.instructions.loads.dload.*;
import ch09.instructions.loads.fload.*;
import ch09.instructions.loads.iload.*;
import ch09.instructions.loads.lload.*;
import ch09.instructions.loads.xaload.*;
import ch09.instructions.references.anewarray.ANEW_ARRAY;
import ch09.instructions.references.arraylength.ARRAY_LENGTH;
import ch09.instructions.references.multianewarray.MULTI_ANEW_ARRAY;
import ch09.instructions.references.newArray.NEW_ARRAY;
import ch09.instructions.reserved.INVOKE_NATIVE;
import ch09.instructions.stores.xastore.*;
import ch09.instructions.math.add.DADD;
import ch09.instructions.math.add.FADD;
import ch09.instructions.math.add.IADD;
import ch09.instructions.math.add.LADD;
import ch09.instructions.math.and.IAND;
import ch09.instructions.math.and.LAND;
import ch09.instructions.math.div.DDIV;
import ch09.instructions.math.div.FDIV;
import ch09.instructions.math.div.IDIV;
import ch09.instructions.math.div.LDIV;
import ch09.instructions.math.iinc.IINC;
import ch09.instructions.math.mul.DMUL;
import ch09.instructions.math.mul.FMUL;
import ch09.instructions.math.mul.IMUL;
import ch09.instructions.math.mul.LMUL;
import ch09.instructions.math.neg.DNEG;
import ch09.instructions.math.neg.FNEG;
import ch09.instructions.math.neg.INEG;
import ch09.instructions.math.neg.LNEG;
import ch09.instructions.math.or.IOR;
import ch09.instructions.math.or.LOR;
import ch09.instructions.math.rem.DREM;
import ch09.instructions.math.rem.FREM;
import ch09.instructions.math.rem.IREM;
import ch09.instructions.math.rem.LREM;
import ch09.instructions.math.sh.*;
import ch09.instructions.math.sub.DSUB;
import ch09.instructions.math.sub.FSUB;
import ch09.instructions.math.sub.ISUB;
import ch09.instructions.math.sub.LSUB;
import ch09.instructions.math.xor.IXOR;
import ch09.instructions.math.xor.LXOR;
import ch09.instructions.references.checkcast.CHECK_CAST;
import ch09.instructions.references.getfield.GET_FIELD;
import ch09.instructions.references.getstatic.GET_STATIC;
import ch09.instructions.references.instanceof_.INSTANCE_OF;
import ch09.instructions.references.invokeinterface.INVOKE_INTERFACE;
import ch09.instructions.references.invokespecial.INVOKE_SPECIAL;
import ch09.instructions.references.invokestatic.INVOKE_STATIC;
import ch09.instructions.references.invokevirtual.INVOKE_VIRTUAL;
import ch09.instructions.references.new_.NEW;
import ch09.instructions.references.putfield.PUT_FIELD;
import ch09.instructions.references.putstatic.PUT_STATIC;
import ch09.instructions.stack.dup.*;
import ch09.instructions.stack.pop.POP;
import ch09.instructions.stack.pop.POP2;
import ch09.instructions.stack.swap.SWAP;
import ch09.instructions.stores.astore.*;
import ch09.instructions.stores.dstore.*;
import ch09.instructions.stores.fstore.*;
import ch09.instructions.stores.istore.*;
import ch09.instructions.stores.lscore.*;
