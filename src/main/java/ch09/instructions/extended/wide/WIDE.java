package ch09.instructions.extended.wide;

import ch09.instructions.base.ByteCodeReader;
import ch09.instructions.base.instruction.Instruction;
import ch09.instructions.loads.aload.ALOAD;
import ch09.instructions.loads.dload.DLOAD;
import ch09.instructions.loads.fload.FLOAD;
import ch09.instructions.loads.iload.ILOAD;
import ch09.instructions.loads.lload.LLOAD;
import ch09.instructions.math.iinc.IINC;
import ch09.instructions.stores.astore.ASTORE;
import ch09.instructions.stores.dstore.DSTORE;
import ch09.instructions.stores.fstore.FSTORE;
import ch09.instructions.stores.istore.ISTORE;
import ch09.instructions.stores.lscore.LSTORE;
